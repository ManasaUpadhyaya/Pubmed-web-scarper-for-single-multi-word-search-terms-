...
for record in records:
    ...
    print(record)
handle.close()'''
'''folder for code : /mnt/data/mupadhyaya'''
...
def strip_brackets(s):
    #the function traverses over each char in the string and appends it to the no_brackets string if the char isn't a []
...
def get_bibliography(soup):
    ...
    '''if article.find('Authorslist' or 'authorlist' or 'author') is True:
        pass
    authorlist = article.find('Authorslist' or 'authorlist' or 'author')'''
...
#df.columns = ['ArticleTitle', 'journal_title', 'volume', 'date', 'pubmed', 'doi_pii_str', 'abstract']
